...
/** Admin型号审核，型号列表查询 */
export const ADMIN_MODEL_AUDIT_QUERY = `${prefix}/admin.php?m=AdminA&c=CheckProduct&a=productList`

/** Admin型号审核，删除型号 */
export const ADMIN_MODEL_AUDIT_DEL = `${prefix}/admin.php?m=AdminA&c=CheckProduct&a=productDel`

/** Admin型号审核，审核型号 */
export const ADMIN_MODEL_REVIEW = `${prefix}/admin.php?m=AdminA&c=CheckProduct&a=productReview`
...
/** Admin固件管理，获取固件历史信息 */
export const ADMIN_FIRE_HISTORY_QUERY = `${prefix}/admin.php?m=Admin&c=Rom&a=deviceRom`

/** 合作商固件管理，固件列表查询 */
export const GET_COOP_FIRMWARES_POST = `${prefix}/index.php?m=Home&c=Rom&a=deviceRomList`

/** 合作商固件管理，上传固件 */
export const COOP_FIRE_UPLOAD = `../${prefix}/index.php?m=Home&c=Rom&a=putObject`
...
/** 合作商固件管理，获取固件历史信息 */
export const COOP_FIRE_HISTORY_QUERY = `${prefix}/index.php?m=Home&c=Rom&a=deviceRom`

/** Admin固件审核，固件列表查询 */
export const ADMIN_FIRE_AUDIT_QUERY = `${prefix}/admin.php?m=Admin&c=CheckRom&a=deviceRomList`

/** Admin固件审核，审核固件 */
export const ADMIN_FIREWARE_AUDIT = `${prefix}/admin.php?m=Admin&c=CheckRom&a=deviceRomReview`

/** Admin固件审核，删除固件 */
export const ADMIN_FIREWARE_AUDIT_DEL = `${prefix}/admin.php?m=Admin&c=CheckRom&a=deviceRomdel`
...
/** 平台管理，设备型号,编辑型号时上传图片 */
export const ADMIN_DEVICE_PIC_UPLOAD = `../${prefix}/admin.php?m=Admin&c=Product&a=putObject`

/** 平台管理，设备型号，编辑型号 */
export const ADMIN_DEVICE_MODEL_UPDATE = `${prefix}/admin.php?m=Admin&c=Product&a=productEditPic`

/** 合作商,设备型号查询 */
export const COOP_DEVICE_MODEL_QUERY = `${prefix}/index.php?m=Home&c=Product&a=productList`

/** 合作商,上传图片 */
export const COOP_DEVICE_PIC_UOLOAD = `../${prefix}/index.php?m=Home&c=Product&a=putObject`
...
/** 合作商,设备型号配置 */
export const COOP_DEVICE_MODEL_SET = `${prefix}/index.php?m=Home&c=Product&a=productEdit`

/** 审核管理，类别查询 */
export const ADMIN_CATE_QUERY = `${prefix}/admin.php?m=Admin&c=CheckProductType&a=prodtList`

/** 审核管理，类别删除 */
export const REVIEW_AUDIT_CATEGORY_DEL = `${prefix}/admin.php?m=Admin&c=CheckProductType&a=prodtDel`

/** 审核管理，类别审核 */
export const ADMIN_CATE_REVIEW = `/${prefix}/admin.php?m=Admin&c=CheckProductType&a=prodtReview`
...
/** admin设备生产，设备返修信息查询 */
export const ADMIN_DEVICE_RETIRE = `${prefix}/admin.php?m=Admin&c=Production&a=adminDeviceRepairList`

/** 合作商权限管理，用户信息查询 */
export const GET_COOP_AUTH_USER_POST = `${prefix}/index.php?m=Home&c=Admin&a=userList`

/** 合作商权限管理，删除用户 */
export const COOP_USER_DELETE = `${prefix}/index.php?m=Home&c=Admin&a=userDel`

/** 合作商权限管理，添加用户 */
export const ADD_COOP_AUTH_USER_POST = `${prefix}/index.php?m=Home&c=Admin&a=userAdd`

/** 合作商权限管理，为用户设置用户组 */
export const COOP_AUTH_SET = `${prefix}/index.php?m=Home&c=Admin&a=groupUserSet`
...
/** 合作商权限管理，用户组权限设置 */
export const COOP_USERGROUP_AUTH_SET = `${prefix}/index.php?m=Home&c=AdminGroup&a=groupPermission`
...
/** 合作商审核固件查询 */
export const COOP_FIRMWARE_QUERY = `${prefix}/index.php?m=Home&c=CheckRom&a=deviceRomList`

/** 合作商审核固件查询 */
export const COOP_FIRMWARE_REVIEW = `${prefix}/index.php?m=Home&c=CheckRom&a=deviceRomReview`

/** 合作商设备管理设备信息查询 */
export const COOP_DEVICE_INFO_QUERY = `${prefix}/index.php?m=Home&c=Device&a=adminDeviceRootsList`

/** 合作商设备管理查看设备返修信息 */
export const COOP_DEVICE_RETIRE_DETAIL = `${prefix}/index.php?m=Home&c=Device&a=adminDeviceRepairList`

/** 合作商设备管理添加设备返修信息 */
export const COOP_DEVICE_RETIRE_ADD = `${prefix}/index.php?m=Home&c=Device&a=adminDeviceRepairAdd`

/** 合作商设备管理添加设备图片上传返修信息 */
export const COOP_DEVICE_UPLOAD_PIC = `../${prefix}/index.php?m=Home&c=Device&a=putObject`
...
/** 合作商设备型号，生成设备ID */
export const COOP_GENERATE_DEVICE_ID = `${prefix}/index.php?m=Home&c=Product&a=deviceAdd`

/** 合作商经销商用户列表 */
export const COOP_AUTH_USER_LIST = `${prefix}/index.php?m=Admin&c=Powers&a=userList`

/** 合作商经销商用户列表的具体权限 */
export const COOP_USER_AUTH = `${prefix}/index.php?m=Admin&c=Powers&a=resList`

/** 编辑合作商经销商用户列表的具体权限 */
export const COOP_AUTH_USER_EDIT = `${prefix}/index.php?m=Admin&c=Powers&a=aclUserPermission`
...
/** admin设备类别编辑 */
export const ADMIN_DEVICE_CATE_EDIT = `${prefix}/admin.php?m=Admin&c=ProductType&a=adminProdtEdit`

/** admin 订单查询 */
export const ADMIN_ORDER_QUERY = `${prefix}/index.php?m=Admin&c=Order&a=adminOrderList`

/** 合作商订单查询 */
export const COOP_ORDER_QUERY = `${prefix}/index.php?m=Home&c=Order&a=adminOrderList`

/** 合作商退款 */
export const COOP_REFUND = `${prefix}/index.php?m=Home&c=Order&a=adminOrderRefund`

/** 合作商设备绑定查询 */
export const COOP_DEVICE_BIND_QUERY = `${prefix}/index.php?m=Home&c=Binding&a=adminUserDeviceManagerList`

/** 合作商设备绑定添加 */
export const COOP_DEVICE_BIND_ADD = `${prefix}/index.php?m=Home&c=Binding&a=adminUserDeviceManagerAdd`

/** 合作商添加设备绑定，获取client id */
export const COOP_CLIENTID_QUERY = `${prefix}/index.php?m=Home&c=Binding&a=oauthBaseList`

/** 合作商添加设备绑定，获取设备绑定账号 */
export const COOP_MANAGER_QUERY = `${prefix}/index.php?m=Home&c=Binding&a=adminClientManagerList`

/** 合作商添加设备绑定，上传excel */
export const COOP_CLIENTID_UPLOAD = `../${prefix}/index.php?m=Home&c=Binding&a=upload`

/** 合作商添加设备绑定，获取excel模板 */
export const COOP_EXCEL_TEMPLATE_GET = `../${prefix}/index.php?m=Home&c=Binding&a=examplese`

/** admin设备绑定查询 */
export const ADMIN_DEVICE_BIND_QUERY = `${prefix}/index.php?m=Admin&c=Binding&a=adminUserDeviceManagerList`

/** 合作商添加设备绑定，解除设备绑定 */
export const COOP_DEL_DEVICE_BIND = `${prefix}/index.php?m=Home&c=Binding&a=AdminUserDeviceManagerDel`

/** admin设备绑定，获取设备绑定账号 */
export const ADMIN_MANAGER_QUERY = `${prefix}/index.php?m=Admin&c=Binding&a=adminClientManagerList`

/** 合作商key绑定管理创建 */
export const COOP_DEVICE_BIND_MANAGE = `${prefix}/index.php?m=Home&c=Key&a=adminClientManagerAdd`

/** 合作商key绑定管理查询 */
export const COOP_KEY_BIND_QUERY = `${prefix}/index.php?m=Home&c=Key&a=adminClientManagerList`

/** 合作商key绑定管理修改密码 */
export const COOP_DEVICE_BIND_UPDATE = `${prefix}/index.php?m=Home&c=Key&a=adminClientManagerUpdate`

/** 合作商多语言查询 */
export const COOP_I18N_QUERY = `${prefix}/index.php?m=Home&c=Multilingual&a=adminTranslationList`

/** 合作商多语言添加 */
export const COOP_I18N_ADD = `${prefix}/index.php?m=Home&c=Multilingual&a=adminTranslationAdd`

/** 合作商多语言修改 */
export const COOP_I18N_UPDATE = `${prefix}/index.php?m=Home&c=Multilingual&a=adminTranslationUpdate`
