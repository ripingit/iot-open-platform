        ...
        <div class="table">
          <el-row>
            <el-col :span="24">
              ...
              <el-button v-if="vmHasAuth(PermissionsLib.DEL_AUDIT_MODEL, tableData.res)" class="btn-circle-delete" type="danger" icon="el-icon-delete" circle @click="deleteAudit"></el-button>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
