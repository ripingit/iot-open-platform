        ...
        <div class="table">
          <el-row>
            <el-col :span="24">
              ...
              <el-button v-if="vmHasAuth(PermissionsLib.DEL_AUDIT_COMPANY, tableData.res)" class="btn-circle-delete btn-circle-right" type="danger" icon="el-icon-delete" circle @click="deleteAudit"></el-button>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
