    ...
    <el-row>
      <el-col :span="24" style="position: relative">
        ...
        <el-col :span="3" style="position: absolute;top: 2.3rem;right:0rem;z-index: 10">
          <el-button type="danger" style="padding: 1.3rem;" icon="el-icon-delete" circle @click="Delete()"></el-button>
        </el-col>
      </el-col>
    </el-row>
    <el-row class="device-model-admin-content">
      <el-col :span="24">
      ...
      <el-col :span="24" class="device-model-admin-table">
        <el-col :span="24">
          <el-table
            v-loading="isLoading"
...
<style scoped>
  ...
  .device-model-admin-content{
    margin-top: 1rem;
    border-radius: .1rem;
    padding: 3rem;
    background-color:#36393E;
  }
  .device-model-admin-table{
    color: #ffffff;
    min-height:52rem;
  }
</style>
