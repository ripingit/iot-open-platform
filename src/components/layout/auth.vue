<template>
  <div class="main">
    ...
    <el-row class="panel">
      <el-col :span="8" class="eligibility" style="text-align: right;">
      ...
      <el-col :span="8" class="eligibility" style="text-align: left;">
        <div class="eligi-icon">
    ...
    <el-dialog title="提交审核" :visible.sync="isDialogVisible" center>
      ...
      <el-row class="form-row" style="margin-top: 1.4rem">
